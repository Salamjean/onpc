...
<body class="flex items-center justify-center min-h-screen p-6 relative overflow-hidden bg-slate-50">
    ...
    <div
        ...
        <div
            class="w-full md:w-[45%] bg-caserne-dark p-12 flex flex-col justify-between relative overflow-hidden text-white">
            <!-- Decorative circle -->
            <div class="absolute top-0 right-0 -mr-20 -mt-20 w-64 h-64 bg-orange-300/30 rounded-full blur-2xl"></div>
            ...
            <div class="relative z-10">
                ...
                <p class="text-blue-100/80 mt-6 text-lg font-medium leading-relaxed max-w-xs">
                    Gérez vos interventions et vos ressources en temps réel.
                </p>
            </div>

            <div class="relative z-10 pt-12">
                <div class="flex items-center gap-3 text-sm font-semibold text-blue-100/80">
        ...
        <div class="w-full md:w-[55%] p-12 md:p-16 flex flex-col justify-center" x-data="{ showPassword: false }">
            ...
            @if ($errors->any())
                <div class="mb-8 bg-orange-50 border-l-4 border-caserne-red p-4 rounded-xl">
            ...
            <form action="{{ route('caserne.auth.login-submit') }}" method="POST" class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        <div
                            class="absolute inset-y-0 left-0 pl-5 flex items-center text-slate-400 group-focus-within:text-caserne-red transition-colors">
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email') }}" required
                            class="block w-full pl-14 pr-6 py-4 bg-slate-50 border border-slate-200 rounded-2xl outline-none text-slate-900 font-semibold focus:ring-4 focus:ring-blue-500/10 focus:border-blue-600 focus:bg-white transition-all"
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        ...
                        <input :type="showPassword ? 'text' : 'password'" id="password" name="password" required
                            class="block w-full pl-14 pr-16 py-4 bg-slate-50 border border-slate-200 rounded-2xl outline-none text-slate-900 font-semibold focus:ring-4 focus:ring-blue-500/10 focus:border-blue-600 focus:bg-white transition-all"
                            placeholder="********">
                        <button type="button" @click="showPassword = !showPassword"
                            class="absolute inset-y-0 right-0 pr-6 flex items-center text-slate-400 hover:text-caserne-red transition-colors">
                ...
                <button type="submit"
                    class="w-full bg-caserne-red hover:bg-blue-900 text-white font-bold py-4 rounded-2xl text-lg transition-all transform active:scale-[0.98] shadow-xl shadow-orange-500/20">
                    Se Connecter
                </button>
            </form>
            ...
            <div class="mt-12 text-center">
                <p class="text-sm font-medium text-slate-500">
                    Première connexion ?
                    <a href="{{ route('caserne.auth.setup-form') }}"
                        class="text-caserne-red font-bold hover:underline ml-1">Activer mon compte</a>
                </p>
            </div>
        </div>
    </div>
