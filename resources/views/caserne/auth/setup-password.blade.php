        ...
        <div
            ...
            <div class="relative z-10 mt-12 space-y-6">
                <div class="flex items-center gap-4">
                    <div
                        class="w-10 h-10 rounded-xl bg-caserne-red flex items-center justify-center font-bold text-sm shadow-lg shadow-red-500/20">
                        01</div>
                    <p class="text-sm font-bold text-blue-100/90 uppercase tracking-widest">Saisie de l'OTP</p>
                </div>
                <div class="flex items-center gap-4">
                    <div
