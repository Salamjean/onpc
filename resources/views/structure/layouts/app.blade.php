...
<head>
    ...
    <title>Portail Structure - ONPC</title>
    <!-- Tailwind CSS -->
...
<body class="bg-gray-50 font-sans antialiased text-gray-800" x-data="{ sidebarOpen: window.innerWidth > 1024 }">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div x-show="sidebarOpen" 
            ...
            @include('structure.layouts.sidebar')
        </div>
        ...
        <div class="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
            ...
            <!-- Navbar -->
            @include('structure.layouts.navbar')
